...
Sedan behöver du också ha node installerat på datorn. Har du inte detta så kan du ladda ner node här <a href="https://nodejs.org/en/download" target="_blank">Node.js/download</a> . Sedan följer du anvisningarna.
