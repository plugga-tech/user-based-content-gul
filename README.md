...
Sedan behöver du också ha node installerat på datorn. Har du inte detta så kan du ladda ner node här `https://nodejs.org/en/download`. Sedan följer du anvisningarna.
